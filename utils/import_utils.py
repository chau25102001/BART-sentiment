    ...
    if USE_TF in ENV_VARS_TRUE_AND_AUTO_VALUES and USE_TORCH not in ENV_VARS_TRUE_VALUES:
        ...
        if _tf_available:
            if version.parse(_tf_version) < version.parse("2"):
                ...
                print(f"TensorFlow version {_tf_version} available.")
    else:
...
if USE_JAX in ENV_VARS_TRUE_AND_AUTO_VALUES:
    ...
    if _flax_available:
        try:
            ...
            print(f"JAX version {_jax_version}, Flax version {_flax_version} available.")
        except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported detectron2 version {_detectron2_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported faiss version {_faiss_version}")
except importlib_metadata.PackageNotFoundError:
    try:
...
try:
    ...
    print(f"Successfully imported ftfy version {_ftfy_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported sympy version {_coloredlogs_available}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported sympy version {_sympy_available}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported tf2onnx version {_tf2onnx_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported onnx version {_onxx_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported pytorch-quantization version {_pytorch_quantization_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported soundfile version {_soundfile_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported tensorflow-probability version {_tensorflow_probability_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported natten version {_natten_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported torchaudio version {_torchaudio_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported phonemizer version {_phonemizer_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported pyctcdecode version {_pyctcdecode_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported librosa version {_librosa_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported oneccl_bind_pt version {ccl_version}")
except importlib_metadata.PackageNotFoundError:
...
try:
    ...
    print(f"Successfully imported decord version {_decord_version}")
except importlib_metadata.PackageNotFoundError:
